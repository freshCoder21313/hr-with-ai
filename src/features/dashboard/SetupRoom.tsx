  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8">
          ...
          <form onSubmit={actions.handleSubmit} className="space-y-4 md:space-y-8">
              ...
              <div className="flex-1">
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={actions.handleSelectSavedJob}
              ...
              {state.selectedJobId !== 'new' && (
                <div className="flex items-end h-[62px] pb-[2px]">
                  <Button
                    ...
                    variant="destructive"
                    size="icon"
                    onClick={(e) => actions.handleDeleteJob(e, parseInt(state.selectedJobId))}
              ...
              <div className="space-y-2 md:space-y-3">
                ...
                <div className="mt-2">
                  <LoadingButton
                    ...
                    variant="ghost"
                    size="sm"
                    onClick={actions.handleResearchCompany}
                    disabled={state.isResearching || !isNonEmptyString(formData.company)}
            ...
            <div className="space-y-2 md:space-y-3">
              <div className="flex justify-between items-center">
                ...
                <LoadingButton
                  ...
                  disabled={state.isExtracting || !isNonEmptyString(formData.jobDescription)}
            ...
            <div className="space-y-2 md:space-y-3">
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    onClick={() => actions.setIsJobModalOpen(true)}
              ...
              <ResumeList
                ...
                onSelect={actions.handleResumeSelect}
                onDelete={actions.handleDeleteResume}
                onTailor={actions.handleTailorClick}
              ...
              {formData.resumeText && formData.jobDescription && (
                <div className="pt-2">
                  <LoadingButton
                    type="button"
                    variant="secondary"
                    onClick={actions.handleAnalyzeResume}
      ...
      <JobRecommendationModal
        ...
        onClose={() => actions.setIsJobModalOpen(false)}
        onSelectJob={actions.handleSelectJob}
        existingResumeId={state.selectedResumeId}
      ...
      <Dialog open={state.showMainCVCloneDialog} onOpenChange={actions.setShowMainCVCloneDialog}>
        <DialogContent>
          ...
          <DialogFooter className="gap-2 sm:gap-0">
            <Button
              variant="outline"
              onClick={() => actions.handleConfirmClone(false)}
              disabled={state.isCloning}
            >
              Use Original
            </Button>
            <LoadingButton
              onClick={() => actions.handleConfirmClone(true)}
              isLoading={state.isCloning}
              loadingText="Cloning..."
            >
              Make a Copy & Use
            </LoadingButton>
      ...
      <TailorResumeModal
        isOpen={state.isTailorModalOpen}
        onClose={() => actions.setIsTailorModalOpen(false)}
        sourceResume={state.resumeToTailor}
        onGenerate={actions.handleGenerateTailoredResume}
      />
    </div>
  );
};
