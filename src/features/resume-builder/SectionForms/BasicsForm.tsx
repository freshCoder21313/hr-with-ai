      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input id="name" value={data.name || ''} onChange={e => handleChange('name', e.target.value)} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="label">Job Title</Label>
            <Input id="label" value={data.label || ''} onChange={e => handleChange('label', e.target.value)} />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t">
            <div className="space-y-2">
                ...
                <Input id="city" value={data.location?.city || ''} onChange={e => handleLocationChange('city', e.target.value)} />
            </div>
            <div className="space-y-2">
                <Label htmlFor="countryCode">Country Code</Label>
                <Input id="countryCode" value={data.location?.countryCode || ''} onChange={e => handleLocationChange('countryCode', e.target.value)} />
            </div>
        </div>
      </CardContent>
    </Card>
